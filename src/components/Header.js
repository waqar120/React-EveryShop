...
const Header = () => {
  ...
  return (
    <Box>
      <AppBar position="static" sx={{ marginBottom: "70px", width:'100%'}}>
        <Toolbar className={headerstyle.appbar}>
          <Link to="/" className={headerstyle.boxe1}>
            {/* Your SVG code here */}
            <svg
          ...
          <Box className={headerstyle.boxe2}>
            <Link to="/men" className={headerstyle.menutitle}>
              MEN
            </Link>
            <Link to="/women" className={headerstyle.menutitle}>
              WOMEN
            </Link>
            <Link to="/kids" className={headerstyle.menutitle}>
              KIDS
            </Link>
          </Box>
          <Box className={headerstyle.boxe3}>
            <Link>
              <SearchIcon />
            </Link>
            <Link to="/cartdetail">
